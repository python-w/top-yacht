        ...
        <Box className="page_outer" sx={{ backgroundColor: "rgba(199, 219, 229, 0.25)", borderRadius: '32px', overflow: 'hidden' }}>
          ...
          <PageBody>
            <GridRow container spacing={4} justifyContent="space-between">
              <Grid item md={3}>
                <FormLabel htmlFor="clubName" isRequired={true}>Club Name</FormLabel>
                <StyledInputBase id="clubName" />
              </Grid>
              <Grid item>
                <FormLabel htmlFor="arch" isRequired={true}>Archive</FormLabel>
            ...
            <GridRow container spacing={4}>
              <Grid item md={3}>
                <FormLabel htmlFor="clubType" isRequired={true}>Type</FormLabel>
                <Box xs={{ gap: '25px' }}>
              ...
              <Grid item md={3}>
                <FormLabel htmlFor="clubType" isRequired={true}>Staff</FormLabel>
                <Box xs={{ gap: '25px' }}>
                  <FormControlLabel control={<Checkbox defaultChecked />} label="Fully Volunteer Run Club" />
                </Box>
              </Grid>
              <Grid item md={3}>
                <FormLabel htmlFor="clubType" isRequired={true}>Source of Entrants</FormLabel>
                <Box xs={{ gap: '25px' }}>
            ...
            <GridRow container spacing={4}>
              <Grid item md={3}>
                <CustomPhoneInput
                  defaultCountry="us"
                  label="Sailing Manager Contact"
                  isRequired={true}
                  value={additionalPhone}
                  onChange={(value) => handleAdditionalPhoneChange(value)}
                />
              </Grid>
            </GridRow>
            <GridRow container spacing={4}>
              ...
              <Grid item md={3}>
                <FormLabel htmlFor="clubName" isRequired={true}>Email Address</FormLabel>
