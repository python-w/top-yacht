import StyledInput from './InputBase';
            ...
            {isEditMode ?
                <tbody>
                    {data.map((row, rowIndex) => (
                        <tr key={rowIndex}>
                            <td><StyledInput type="text" value={row.name} onChange={(e) => onInputChange(e.target.value, rowIndex, 'name')} /></td>
                            ...
                            <td><StyledInput type="text" value={row.email} onChange={(e) => onInputChange(e.target.value, rowIndex, 'email')} /></td>
